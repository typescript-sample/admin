...
insert into users (user_id,username,email,display_name,image_url,status,gender,phone,title,position) values ('cSojoy4GUs','ronaldo','ronaldo@gmail.com','Ronaldo','https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Ronaldo_Cannes.jpg/250px-Ronaldo_Cannes.jpg','I','M','0987654321','Mr','E');
...
insert into users (user_id,username,email,display_name,image_url,status,gender,phone,title,position) values ('ftMd80w4x2','sergino.dest','sergino.dest@gmail.com','Sergiño Dest','https://upload.wikimedia.org/wikipedia/commons/6/6e/Sergino_Dest.jpg','I','M','0987654321','Mr','E');
...
insert into users (user_id,username,email,display_name,image_url,status,gender,phone,title,position) values ('nOf40L4Qxy','victor.lindelof','victor.lindelof@gmail.com','Victor Lindelöf','https://upload.wikimedia.org/wikipedia/commons/c/cc/CSKA-MU_2017_%286%29.jpg','I','M','0987654321','Mr','E');
...
insert into locale (code,name,native_name,country_code,country_name,native_country_name,date_format,first_day_of_week,decimal_separator,group_separator,currency_code,currency_symbol,currency_decimal_digits,currency_pattern,currency_sample) values
  ...
  ('uz-Cyrl-UZ','Uzbek (Cyrillic, Uzbekistan)','Ўзбек (Ўзбекистон)','UZ','Uzbekistan','Ўзбекистон Республикаси','dd.MM.yyyy',2,',',' ','UZS','сўм',2,3,'10 000,00 сўм'),
  ('uz-Latn-UZ','Uzbek (Latin, Uzbekistan)','U''zbek (U''zbekiston Respublikasi)','UZ','Uzbekistan','U''zbekiston Respublikasi','dd/MM yyyy',2,',',' ','UZS','лв',2,3,'10 000 so''m'),
